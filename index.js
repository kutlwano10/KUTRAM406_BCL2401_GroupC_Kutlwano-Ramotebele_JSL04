...
const monsterEnergy = userPreference == 'Sugar-free' ? "Sugar-free": userPreference == 'Regular' || userPreference == '' ? "Regular" : "undefined";

console.log(monsterEnergy);
...
const canStock = cansLeft < 5 ? "Time to Stock!" : "We're stocked!";
...
const energyBoost = heartRate < 100 ? "Boost needed!" : "Energy level are high!";
console.log(energyBoost);
...
const coolDrink = currentTemp <= 5 ? "Chilled to perfection!" : "Needs a cooler!" 
...
const drinkMonster = currentHour > 7 && currentHour < 24 ? "Unleash the beast!": "Better stick to water";
